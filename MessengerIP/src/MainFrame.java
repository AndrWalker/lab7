...
private static final int SERVER_PORT1 = 4567;
...
//if (!destinationAddress.matches("^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$")) {
//JOptionPane.showMessageDialog(this,
//"Некоректный ip-адрес", "Ошибка",
//JOptionPane.ERROR_MESSAGE);
//return;
//}
// Создаем сокет для соединения
final Socket socket =
new Socket(destinationAddress, SERVER_PORT1);
